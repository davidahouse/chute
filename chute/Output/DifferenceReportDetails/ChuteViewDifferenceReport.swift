//
//  ChuteScreenshotDifferenceReport.swift
//  chute
//
...
class ChuteViewDifferenceReport: ChuteOutputDifferenceRenderable {
    ...
    private func newViews(difference: ChuteDetailDifference) -> String {
        var views = ""
    ...
    private func changedViews(difference: ChuteDetailDifference) -> String {
        var views = ""
